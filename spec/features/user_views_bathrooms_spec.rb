...
So I can find a good bathroom when needed." do
  scenario "User views list of bathrooms" do
    user = User.create!(email: "other@email.com", encrypted_password: "password", password: "password")
    bathroom = Bathroom.create!(user: user, rating_average: 5.0, location_name: "Starbucks", street_address: "62 Boylston", zip_code: "02116", description: "Back corner. Key from barista. Watch out for joe.")
    visit '/bathrooms'
